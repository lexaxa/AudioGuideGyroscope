...
//        setContentView(R.layout.activity_play_background_audio);
        ...
        backgroundAudioProgress = null;//(ProgressBar)findViewById(R.id.btn_play_audio);
        // Get audio file url textview.
        audioFileUrlTextView = (TextView)findViewById(R.id.btn_play_audio);
        ...
        Button startBackgroundAudio = (Button)findViewById(R.id.btn_play_audio);
        ...
        Button pauseBackgroundAudio = (Button)findViewById(R.id.btn_play_audio);
        ...
        Button stopBackgroundAudio = (Button)findViewById(R.id.btn_stop_audio);
